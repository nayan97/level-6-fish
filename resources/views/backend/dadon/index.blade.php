        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>দাদনের হিসাব</h4>
                    <h6>দাদনের হিসাব পরিচালনা</h6>
                </div>
                <div class="page-btn">
                    <a href="{{route('dadon.create')}}" class="btn btn-added"><img
                            src="{{asset('assets/img/icons/plus.svg')}}" alt="img" class="me-1">দাদন সংযোজন</a>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                @foreach($dadons as $dadon)
                                    <tr>
                                        ...
                                        <td>{{ $dadon->total_given_amount ?? 'N/A' }}</td>
                                        <td>{{ $dadon->collections->sum('collection_amount') ?? '0' }}</td>
                                        <td>{{ ($dadon->total_given_amount - $dadon->collections->sum('collection_amount')) }}
                                        </td>
                                        <td>{{ $dadon->given_date }}</td>
                                        <td>{{ $dadon->due_pay_date }}</td>
                                        <td>{{ $dadon->note }}</td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <a class="me-3" href="{{route('collections.create', $dadon->id)}}">
