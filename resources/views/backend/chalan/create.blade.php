...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('chalans.store') }}" method="POST">
                        @csrf
                                    ...
                                    <div class="input-group">
                                        <select name="mohajon_id"
                                            ...
                                            @foreach($mohajons as $mohajon)
                                                <option value="{{ $mohajon->id }}" {{ old('mohajon_id') == $mohajon->id ? 'selected' : '' }}>{{ $mohajon->name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="invoice_no"
                                        ...
                                        value="{{ old('invoice_no', $invoice_no ?? '1202500123') }}" readonly>
                                    @error('invoice_no')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                            ...
                                            <tr class="fish-item">
                                                <td>
                                                    <select name="items[{{ $index }}][item_name]"
                                                        ...
                                                        @foreach($products as $product)
                                                            <option value="{{ $product->name }}" {{ (old('items.'.$index.'.item_name') == $product->name) ? 'selected' : '' }}>{{ $product->name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <td>
                                                    <input type="number" name="items[{{ $index }}][quantity]"
                                                        ...
                                                        placeholder="পরিমাণ" step="0.01" value="{{ $item['quantity'] ?? '' }}">
                                                ...
                                                <td>
                                                    <input type="number" name="items[{{ $index }}][unit_price]"
                                                        ...
                                                        placeholder="মূল্য" step="0.01" value="{{ $item['unit_price'] ?? '' }}">
                        ...
                        <div id="expense-items">
                                    ...
                                    <div class="row expense-item mt-2">
                                        <div class="col-md-4">
                                            <select name="expenses[{{ $index }}][expense_type]"
                                                ...
                                                @foreach($expensesName as $expenseName)
                                                    <option value="{{ $expenseName }}" {{ (old('expenses.'.$index.'.expense_type') == $expenseName) ? 'selected' : '' }}>{{ $expenseName }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" name="expenses[{{ $index }}][amount]"
                                                ...
                                                placeholder="টাকা" step="0.01" value="{{ $expense['amount'] ?? '' }}">
                            ...
                            @else
                                <div class="row expense-item mt-2">
                                    <div class="col-md-4">
                                        <select name="expenses[0][expense_type]"
                                    ...
                                    <div class="col-md-3">
                                        <input type="number" name="expenses[0][amount]" class="form-control expense-amount"
                            ...
                            <div class="col-md-6">
                                <div class="summary-box">
                                    {{--<div class="summary-row">
                                        ...
                                        <span class="value d-flex align-items-center">
                                            <input type="number" step="0.01" name="overall_discount_amount"
                                                class="form-control text-right @error('overall_discount_amount') is-invalid @enderror"
                                                placeholder="0" id="overall-discount-amount" style="width: 100px;"
                                                value="{{ old('overall_discount_amount') }}">
                                            <input type="number" step="0.01" name="overall_discount_percent"
                                                class="form-control text-right ml-1 @error('overall_discount_percent') is-invalid @enderror"
                                                placeholder="%" id="overall-discount-percent" style="width: 100px;"
                                                value="{{ old('overall_discount_percent') }}">
                                    ...
                                    <div class="summary-row">
                                        ...
                                        <span class="value d-flex align-items-center">
                                            <input type="number" step="0.01" name="overall_vat_amount"
                                                class="form-control text-right @error('overall_vat_amount') is-invalid @enderror"
                                                placeholder="0" id="overall-vat-amount" style="width: 100px;"
                                                value="{{ old('overall_vat_amount') }}">
                                            <input type="number" step="0.01" name="overall_vat_percent"
                                                class="form-control text-right ml-1 @error('overall_vat_percent') is-invalid @enderror"
                                                placeholder="%" id="overall-vat-percent" style="width: 100px;"
                                                value="{{ old('overall_vat_percent') }}">
                                            <span class="ml-2">৳</span>
                                        </span>
                                    ...
                                    <div class="summary-row">
                                        ...
                                        <input type="hidden" name="total_expenses_amount" id="total-expenses-amount-hidden"
                                            value="{{ old('total_expenses_amount') }}">
                                    </div>
                                    <div class="summary-row">
                                        <span class="label">কাঁচা বিক্রয়</span>
                                        <span class="value" id="sub-total-display">৳ {{ old('sub_total', '0.00') }}</span>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="customer_name_modal">পাইকারের নাম <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="customer_name_modal" name="name" required>
                        </div>
                        <div class="form-group mt-3">
                            <label for="customer_phone_modal">মোবাইল নং <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="customer_phone_modal" name="phone" required>
                        </div>
                        <div class="form-group mt-3">
                            <label for="customer_address_modal">ঠিকানা</label>
                            <textarea class="form-control" id="customer_address_modal" name="address"></textarea>
                        </div>
                    </div>
