            ...
            <form action="{{ route('admin.dashboard') }}" method="GET">
                <div class="d-flex justify-content-end">
                    <div class="form-group mb-0 me-2">
                        ...
                        <input type="date" name="from_date" class="form-control" value="{{ $from ?? \Carbon\Carbon::now('Asia/Dhaka')->toDateString() }}">
                    </div>
                    <div class="form-group mb-0 me-2">
                        <label for="filter_date" class="form-label">শেষ তারিখ</label>
                        <input type="date" name="to_date" class="form-control" value="{{ $to ?? \Carbon\Carbon::now('Asia/Dhaka')->toDateString()  }}">
                    </div>
                ...
                <div class="col-lg-3 col-sm-6 col-12 mb-4">
                    <a href="{{ route('dadon.due_soon') }}" class="text-decoration-none">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widgetcontent">
                                <h5>৳ <span class="counters text-info">{{ number_format($total_commission - $total_expense) }}</span></h5>
                                <h6 class="fw-bold">মোট আয়</h6>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-3 col-sm-6 col-12 mb-4">
                    <a href="{{ route('dadon.due_soon') }}" class="text-decoration-none">
                        <div class="dash-widget dash1">
                            ...
                            <div class="dash-widgetcontent">
                                <h5>৳ <span class="counters text-warning">{{ number_format($total_expense) }}</span></h5>
                ...
                <div class="col-lg-3 col-sm-6 col-12 mb-4">
                    <a href="{{ route('dadon_add.index') }}" class="text-decoration-none">
                        <div class="dash-widget dash3">
                            ...
                            <div class="dash-widgetcontent">
                                <h5>৳ <span class="counters text-success">{{ number_format($total_baki_aday) }}</span></h5>
                ...
                <div class="col-lg-3 col-sm-6 col-12 mb-4">
                    <a href="{{ route('dadon.due_soon') }}" class="text-decoration-none">
                        <div class="dash-widget dash3">
                            ...
                            <div class="dash-widgetcontent">
                                <h5>৳ <span class="counters text-success">{{ number_format($total_commission) }}</span></h5>
                ...
                <div class="col-lg-3 col-sm-6 col-12 mb-4">
                    <a href="{{ route('uttolon.index') }}" class="text-decoration-none">
                        <div class="dash-widget dash3">
                            ...
                            <div class="dash-widgetcontent">
                                <h5>৳ <span class="counters text-success">{{ number_format($uttolon_amount) }}</span></h5>
                                <h6 class="fw-bold">উত্তোলন</h6>
                            </div>
                        </div>
                    </a>
                </div>
                        ...
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-white btn-sm dropdown-toggle" type="button"
                                    ...
                                    {{ $year }} <img src="{{ asset("assets/img/icons/dropdown.svg") }}" alt="img"
                                        class="ms-2">
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    @foreach($years as $y)
                                    <li>
                                        <a href="{{ route('dashboard.year', $y) }}" class="dropdown-item">{{ $y }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
